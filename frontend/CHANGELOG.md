...
* Frontend-Version mit dem Patch-Release des Gesamtprojekts auf `0.3.1` synchronisiert.
...
* Release Candidate als stabile Frontend-Version veröffentlicht.
* Frontend-Version auf `0.3.0` aktualisiert.
